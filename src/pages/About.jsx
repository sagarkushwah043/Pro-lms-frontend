...
function About() {
  ...
  return (
    ...
    >
      {/* Hero Section */}
      <section
        className={`text-white py-24 transition-colors duration-300 ${
          darkMode
      ...
      >
        <div className="container mx-auto text-center px-4">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6">About ProLMS</h1>
          <p className="text-lg md:text-xl max-w-3xl mx-auto leading-relaxed">
            ProLMS is a professional Learning Management System designed for modern learners. Explore
            our platform with an intuitive interface, high-quality courses, and personalized learning
            experience.
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto py-20 px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {[
            ...
            <div
              key={idx}
              className={`p-8 rounded-xl shadow-lg hover:shadow-2xl transition transform hover:-translate-y-2 duration-300 ${
                darkMode ? "bg-gray-800" : "bg-white"
              }`}
            >
              <h3 className="text-2xl font-semibold mb-3 text-teal-500 dark:text-teal-400">
                {feature.title}
              </h3>
      ...
      {/* Call to Action */}
      <section
        className={`py-20 mt-12 text-center px-4 transition-colors duration-300 ${
          darkMode
            ? "bg-gradient-to-r from-teal-900 to-blue-900 text-gray-200"
            : "bg-gradient-to-r from-teal-100 to-blue-100 text-gray-800"
        }`}
      >
        ...
        <button
          ...
          className={`font-semibold px-8 py-4 rounded-full shadow-lg hover:shadow-2xl hover:scale-105 transition transform duration-300 ${
            darkMode
